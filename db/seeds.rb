...
Elf.create!(
  ...
  price_per_day: 150,
  user_id: marine.id,
  image.attach(io: URI.open('https://res.cloudinary.com/dobmq9hxw/image/upload/v1669210093/d0uysi0ywadkhztyogkq.jpg'), filename: 'rayme1.png', content_type: 'image/png')
)
Elf.create!(
  name: "Hokey",
  ...
  price_per_day: 41,
  user_id: etienne.id,
  photo: 'https://www.hp-lexicon.org/wp-content/uploads/2016/01/dobby2-mk.png'
)
Elf.create!(
  name: "Hooky",
  ...
  price_per_day: 23,
  user_id: pascal.id,
  photo: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRDeFfURDpKXwh7uBjvdQY38jTaWIf420BNEBFLC9jMWUQ40Yn3JHb9oYLwUR6wcL9LLdU&usqp=CAU'
)
Elf.create!(
  name: "Kreattur",
  ...
  price_per_day: 52,
  user_id: marine.id,
  photo: 'https://static.wikia.nocookie.net/harrypotter/images/b/b4/Kreattur_HP7.jpg/revision/latest?cb=20101225104040&path-prefix=fr'
)
Elf.create!(
  name: "Winky",
  ...
  price_per_day: 12,
  user_id: benoit.id,
  photo: 'https://www.google.com/imgres?imgurl=https%3A%2F%2Flookaside.fbsbx.com%2Flookaside%2Fcrawler%2Fmedia%2F%3Fmedia_id%3D100067518962299&imgrefurl=https%3A%2F%2Fm.facebook.com%2F113474770511247%2Fphotos%2Fa.113474813844576%2F113475347177856%2F&tbnid=6F2dZ4-XzJc3OM&vet=10CAsQxiAoAWoXChMIqJeznIbE-wIVAAAAAB0AAAAAEA4..i&docid=Ho4ugpXd3t16DM&w=502&h=502&itg=1&q=winky%20harry%20potter&ved=0CAsQxiAoAWoXChMIqJeznIbE-wIVAAAAAB0AAAAAEA4'
)
Elf.create!(
  name: "Gollum",
  ...
  price_per_day: 69,
  user_id: johann.id,
  photo: 'https://kultt.fr/wp-content/uploads/2014/01/Gollum-solihull-police.jpg'
)
Elf.create!(
  name: "Butters",
  ...
  price_per_day: 1,
  user_id: pierre.id,
  photo: 'https://media-exp1.licdn.com/dms/image/C4E03AQFt8iFWEBqA6g/profile-displayphoto-shrink_800_800/0/1554805763838?e=2147483647&v=beta&t=wyAM8gnKkd7rPe6kAq3mI6E3XfxqZHGGd7jNTevatT0'
)
Elf.create!(
  name: "Elfo",
...
Elf.create!(
  ...
  price_per_day: 42,
  user_id: celine.id,
  photo: 'https://static.wikia.nocookie.net/dragonball/images/d/d6/Majin_boo.jpeg/revision/latest/scale-to-width-down/250?cb=20130503160405&path-prefix=fr'
)
Elf.create!(
  name: "Sam",
  ...
  price_per_day: 14,
  user_id: pierre.id,
  photo: 'https://i.pinimg.com/originals/fd/f7/07/fdf7076a17434bc9217ea4f955212347.jpg'
)
Elf.create!(
  name: "lutin",
...
Elf.create!(
  ...
  price_per_day: 12,
  user_id: johann.id,
  photo: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTFHF3H2ZPH1cdkDXWeqBGDrSP8v6lnEQ-v_g&usqp=CAU'
)
Elf.create!(
  name: "Papotte",
